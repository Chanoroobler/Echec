...
/// on remonte les dossiers jusqu'à trouver <c>Echec.sln</c> (racine du dépôt), puis on
/// pointe sur <c>src/Echec.Game/Assets/…</c>. Ainsi l'éditeur écrit dans les MÊMES
...
internal static class AssetPaths
{
    ...
    public static string AssetsDir  => Path.Combine(RepoRoot, "src", "Echec.Game", "Assets");
