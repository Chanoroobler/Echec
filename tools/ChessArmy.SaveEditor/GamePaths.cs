...
///    dossiers depuis l'exécutable jusqu'à <c>ChessArmy.sln</c>, comme l'éditeur de maps ;
///  • les SAUVEGARDES, sous <c>%AppData%\Echec\save</c> — mêmes chemins que
///    <c>ChessArmy.Engine.Persistence.SaveService</c>, qu'on ne peut pas réutiliser ici (il dépend de MonoGame).
...
internal static class GamePaths
{
    ...
    public static string ConfigDir => Path.Combine(RepoRoot, "src", "ChessArmy.Game", "Assets", "Config");
    ...
    private static string FindRepoRoot()
    {
        ...
        // valeurs codées d'ChessArmy.Core, qui restent utilisables.
