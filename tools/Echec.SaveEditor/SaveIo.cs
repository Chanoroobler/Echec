...
/// <c>Echec.Engine.Persistence.SaveService</c> (indenté, champs inclus, enums en texte) : c'est ce qui
...
/// <summary>
/// Copie du <c>ProfileDto</c> d'Echec.Engine (méta-progression). Dupliquée plutôt que référencée : le DTO
/// vit dans Echec.Engine, qui tire MonoGame. Les NOMS de propriétés font le contrat — les garder alignés.
/// </summary>
