...
/// <summary>
/// Remplit les registres statiques d'<c>Echec.Core</c> depuis les JSON du jeu, exactement comme
/// <c>EchecGame.LoadUnitConfig</c> &amp; co. Sans ça, l'éditeur ne proposerait que les valeurs codées
