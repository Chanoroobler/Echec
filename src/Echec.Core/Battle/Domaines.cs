...
public static class Domaines
{
    ...
    private static IReadOnlyList<DomaineDef> Defaults() => new[]
    {
        ...
        new DomaineDef(Domaine.Tour, Cls("Sentinelle", "sentinelle", hp: 12, dmg: 4, move: 3, attack: 3)),
        new DomaineDef(Domaine.Dame, Cls("Capitaine", "capitaine", hp: 12, dmg: 5, move: 3, attack: 1)),
    };
