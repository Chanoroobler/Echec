...
public sealed class UnitClass
{
    ...
    /// <summary>
    /// Identifiant d'asset UNIQUE (voir <see cref="Name"/>) : c'est AUSSI le nom du PNG à charger dans
    /// <c>Assets/Units/&lt;asset&gt;_*.png</c> — un sprite par classe (plus de sprite partagé).
    /// </summary>
