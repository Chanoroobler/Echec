...
using ChessArmy.Engine.Display;
...
/// </summary>
public class ChessArmyGame : Microsoft.Xna.Framework.Game, IDisplayService
{
    ...
    private static void LoadCampaignConfig()
    {
        ...
        try
        {
            ChessArmy.Core.Campaign.CampaignPlan.Load(
                ChessArmy.Core.Campaign.CampaignPlan.FromJson(System.IO.File.ReadAllText(path)));
        }
        catch (System.Exception ex)
        {
